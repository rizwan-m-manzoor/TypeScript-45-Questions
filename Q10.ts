...
const famous_person: string = "Albert Einstein"; // Store the author's name
const message: string = `${famous_person} once said, "A person who never made a mistake never tried anything new."`; // Compose the message
...
const strippedName: string = nameWithWhitespace.trim(); // Strip leading and trailing whitespace
