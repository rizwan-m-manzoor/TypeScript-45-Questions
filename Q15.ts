...
const guestWhoCantMakeIt: string = "Jane Austen";
...
const newGuest: string = "Leonardo da Vinci";
const indexOfCantMakeItGuest: number = dinnerGuests.indexOf(guestWhoCantMakeIt);
